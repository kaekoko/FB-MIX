      ...
      <Table className="all-package theme-table no-footer">
        <tbody>
            ...
            <>
              ...
              <tr>
                ...
                <td className="text-start">
                  {" "}
                  {fullObj?.user?.payment_account?.bank_name}
                </td>
              </tr>
              <tr>
                ...
                <td className="text-start">
                  {fullObj?.user?.payment_account?.bank_holder_name}
                </td>
              </tr>
              <tr>
                <td className="text-start fw-semibold">
                ...
                <td className="text-start">
                  {" "}
                  {fullObj?.user?.payment_account?.bank_account_no}
                </td>
              </tr>
              <tr>
                <td className="text-start fw-semibold">{t("BankIFSCCode")} </td>
                <td className="text-start">
                  {fullObj?.user?.payment_account?.ifsc}
                </td>
              </tr>
              <tr>
                <td className="text-start fw-semibold">
                ...
                <td className="text-start">
                  {fullObj?.user?.payment_account?.swift}
                </td>
              </tr>
            </>
          )}
          <tr>
            ...
            <td className="text-start">{fullObj?.payment_type}</td>
          </tr>
          {fullObj?.status && (
            <tr>
