...
export const ProductTabTitleListData = [
  ...
  },
  {
    title: "Setup",
    icon: <RiToolsLine />,
    inputs: ["tags", "categories", "cross_sell_product_id"],
  },
  {
    title: "Images",
    icon: <RiImageLine />,
    inputs: ["product_thumbnail", "product_images"],
  },
  {
    title: "SEO",
    icon: <RiEarthLine />,
  ...
  },
  {
    title: "Shipping&Tax",
    icon: <RiTruckLine />,
    inputs: ["is_return", "is_cod", "shipping_days", "tax_id"],
  },
  {
    title: "Status",
    icon: <RiCheckboxCircleLine />,
    inputs: ["status", "is_free_shipping", "is_changeable", "is_refundable"],
  },
];
...
export const depositWithdrawHistory = [
  {
    value: "",
    name: "All",
  },
